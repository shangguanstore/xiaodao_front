...
Component({
    ...
    data: {
        circleList: [], //圆点数组
        awardList: [], //奖品数组
        colorCircleFirst: '#FE3426', //圆点颜色1       #FFDF2F
        colorCircleSecond: '#FFFFFF', //圆点颜色2       #FE4D32
        colorAwardDefault: '#FFEEEE', //奖品默认颜色    #fec901
        colorAwardSelect: 'rgba(21,30,38,0.35)', //奖品选中颜色      #FF4F40
        colorAwardDesSelect: '#FFFFFF',
        colorAwardDesDefault: '#7F3E3E',
    ...
    ready: function () {
        ...
        setInterval(function () {
            if (_this.data.colorCircleFirst == '#FE3426') {
                _this.setData({
                    colorCircleFirst: '#FFFFFF',
                    colorCircleSecond: '#FE3426',
                })
            } else {
                _this.setData({
                    colorCircleFirst: '#FE3426',
                ...
                if (time < 200 || index != which) {
                    ...
                    setTimeout(function () {
                        if (index == which) {
                            ...
                            //   }
                            // })
                            _this.triggerEvent('haveGet', _this.data.awardList[index])
                        } else {
                            //未中奖
                            wx.showModal({
                                title: '提示',
