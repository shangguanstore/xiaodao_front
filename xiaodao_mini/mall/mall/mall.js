...
//获取应用实例
var app = getApp()
var lib = require('../../utils/lib/index.js')
...
Page({
    ...
    toDetailsTap: function (e) {
        wx.navigateTo({
            url: "/mall/goods-details/goods-details?id=" + e.currentTarget.dataset.id
        })
    },
    ...
    mallInit: function () {
        ...
        wx.request({
            url: app.globalData.subDomain + '/score/send/rule',
            data: {
                code: 'goodReputation'
            },
            success: function (res) {
        ...
        // 获取砍价设置
        wx.request({
            url: app.globalData.subDomain + '/shop/goods/kanjia/list',
            data: {},
            success: function (res) {
                if (res.data.code == 0) {
